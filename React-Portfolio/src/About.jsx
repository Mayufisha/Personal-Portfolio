function About(){
    ...
    <div className="md:flex md:items-center md:gap-10">
      ...
      <div className="mt-4 md:mt-0 text-center md:text-left">
        ...
        <p className="text-slate-300">I began my coding journey on mobile devices, exploring the fundamentals of website development using HTML, CSS, and JavaScript.</p>
      </div>
    </div>
    ...
    <div className="md:flex md:flex-row-reverse md:items-center md:gap-10">
      ...
      <div className="mt-4 md:mt-0 text-center md:text-right">
        ...
        <p className="text-slate-300">During my university studies, I focused on website development, C++ console applications, and strengthening my problem-solving skills in programming.</p>
      </div>
    </div>
    ...
    <div className="md:flex md:items-center md:gap-10">
      ...
      <div className="mt-4 md:mt-0 text-center md:text-left">
        ...
        <p className="text-slate-300">I advanced my skills by learning React for dynamic web applications and explored UI/UX design using Figma, alongside improving my JavaScript expertise.</p>
      </div>
    </div>
    ...
    <div className="md:flex md:flex-row-reverse md:items-center md:gap-10">
      ...
      <div className="mt-4 md:mt-0 text-center md:text-right">
        ...
        <p className="text-slate-300">Currently, I am focusing on website development, C++ console applications, and experimenting with Python graphics to build interactive applications.</p>
      </div>
    </div>
